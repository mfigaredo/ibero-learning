...
<div class="card" id="course-sidebar">
    ...
    <div class="card-body">
        ...
        <div class="card-text">
            {!! __('Unidades de tipo archivo: <span class="badge badge-dark float-right">:units</span>', ['units' => $course->totalFileUnits()]) !!}
        </div>
        <div class="card-text">
            {!! __('Unidades de tipo video: <span class="badge badge-dark float-right">:units</span>', ['units' => $course->totalVideoUnits()]) !!}
        </div>
        <div class="card-text">
