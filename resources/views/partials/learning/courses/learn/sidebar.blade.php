<div class="col-xs-12 col-xl-3 col-md-4 col-sm-4 col-lg-3">
    <div class="card">
        ...
        <div class="card-footer">
            ...
            @endcan
            <a href="{{ route('courses.topics.index', ['course' => $course]) }}" class="site-btn btn-block">
                {{ __('Ir al foro') }}
            </a>
        </div>
    </div>
                    ...
                    <table class="table">
                        <tbody>
                            <tr>
                                ...
                                <td><a href="#" onclick="event.preventDefault(); window.location.href = '${url}'">${downloadText}</a></td>
                            </tr>
                        </tbody>
                    </table>
                `;
