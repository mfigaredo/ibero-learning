...
trait ManageCourses 
{
    ...
    public function createCourse() {
        ...
        return view('teacher.courses.edit', compact('course', 'title', 'textButton', 'options'));
    }
    ...
    public function editCourse(Course $course) {
        ...
        $update = true;
        return view('teacher.courses.edit', compact('course', 'title', 'textButton', 'options', 'update'));
    }
