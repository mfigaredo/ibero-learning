...
class RouteResource {
     ...
     * Build show routes
     *
     * Route::get('/courses/{course}', 'TeacherController@showCourse')->name('courses.show');
     *
     */
     ...
     * Build edit routes
     *
     * Route::get('/courses/{course}/edit', 'TeacherController@editCourse')->name('courses.edit');
     *
     */
     ...
     *
     * Route::delete('/courses/{course}', 'TeacherController@destroyCourse')->name('courses.destroy');
     *
     */
